  ...
  return (
    <aside className="flex h-screen w-full flex-col items-center justify-center overflow-y-auto  bg-white py-8 ml-2">
      <nav className="flex flex-col items-center space-y-6">
        <div
          className={cn(
            "w-[40px] h-[40px]  rounded-[8px] flex items-center justify-center p-1 bg-gray-100",
            {
              ["bg-[#fadfd6b4]"]: pathName === "/",
            }
          )}
        >
          <Link
        ...
        <div
          className={cn(
            "w-[40px] h-[40px]  rounded-[8px] flex items-center justify-center p-1 bg-gray-100",
            {
              ["bg-[#fadfd6b4]"]: pathName === "/dashboard",
            }
          )}
        >
          <Link
            ...
            >
              <g id="dashboard-circle">
                <path
                  ...
                  stroke={pathName === "/dashboard" ? "#E65527" : "#000"}
                  strokeWidth="1.5"
                  strokeLinecap="round"
            ...
            >
              <g id="video-replay">
                <path
                  ...
                  stroke={pathName === "/video" ? "#E65527" : "#000"}
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
            ...
            >
              <g id="more-01">
                <path
                  ...
                  stroke={pathName === "/more" ? "#E65527" : "#000"}
                  strokeWidth="2.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
